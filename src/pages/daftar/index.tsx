            ...
            <div className="mx-20 mb-2 pt-2">
                ...
                <div className="grid grid-cols-2 w-full">
                    <div className="grid grid-cols-2 mt-10 mb-5 bottom-0 left-0 w-8/12">
                        <button className="text-xl text-[#2570EB] underline underline-offset-4 hover:no-underline text-start w-10/12">Informasi Umum</button>
                        <button className="text-xl text-black underline underline-offset-4 hover:no-underline text-start">Informasi Pendaftaran</button>
                    </div>
                    <div>
                        <div className="grid grid-cols-4 mt-10 mb-5 bottom-0 right-0 gap-4 w-10/12">
                            <div></div>
                            <div></div>
                            <button className="btn btn-outline btn-primary"><Link href="#">Kembali</Link></button>
                            <button className="btn btn-primary text-white"><Link href="/daftar/data-daftar">Selanjutnya</Link></button>
                        </div>
                    </div>
                </div>
            </div>
