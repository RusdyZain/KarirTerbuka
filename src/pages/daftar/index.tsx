            ...
            <div className="mx-24 mb-2 pt-2">
                ...
                <div className="flex flex-row w-full">
                    <div className="basis-1/2 flex flex-row items-end mb-4">
                        <button className="text-[#2570EB] basiqs-1/3underline underline-offset-4 hover:no-underline">Informasi umum</button>
                        <button className="text-black basis-1/3 place-content-start underline underline-offset-4 hover:no-underline">Informasi pendaftaran</button>
                    </div>
                    <div className="basis-1/2">
