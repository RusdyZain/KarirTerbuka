            ...
            <div className="mx-24 mb-2 pt-2">
                ...
                <div className="mt-2 flex flex-row">
                    <div className="basis-1/2">
                        <h1 className="text-4xl font-semibold">Informasi Pendaftaran</h1>
                ...
                <div className="flex flex-row w-full">
                    <div className="basis-1/2 flex flex-row items-end mb-4">
                        <button className="text-xl text-black basis-1/5 underline underline-offset-4 hover:no-underline">Informasi Umum</button>
                        <button className="text-xl text-[#2570EB] basis-1/3 underline underline-offset-4 hover:no-underline">Informasi Pendaftaran</button>
                    </div>
                    <div className="basis-1/2">
                        <div className="flex flex-row mt-10 mb-5 items-end justify-end gap-4 w-10/12">
                            <button className="basis-1/5 btn btn-outline btn-primary"><Link href="/daftar">Kembali</Link></button>
                            <button className="basis-1/5 btn btn-primary text-white"><Link href="#">Daftar</Link></button>
                        </div>
                    </div>
                </div>
            </div>
