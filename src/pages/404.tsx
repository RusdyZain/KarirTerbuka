...
export default function NotFound() {
    return (
        <div data-theme="light" className="h-screen grid justify-items-center pt-20 text-[#2570EB]">
            ...
            <h1 className="text-5xl mt-[-90px] font-bold">Halaman Tidak Ditemukan</h1>
            <h2 className="text-3xl mt-[-130px] font-semibold w-[60rem] text-center">Halaman yang Anda cari tidak ada. <br /> Silakan periksa URL atau arahkan ke bagian lain dari situs ini.</h2>
