...
export default function FormDaftar() {
    ...
    return (
        <div className="mt-6 w-9/12">
            ...
            <div className="mt-6">
                <h2 className="text-lg font-semibold">Email Pengguna</h2>
            ...
            <div className="mt-6">
                <h2 className="text-lg font-semibold">Sandi</h2>
            ...
            <div className="mt-6">
                <h2 className="text-lg font-semibold">Masukkan Ulang Sandi</h2>
            ...
            <div className="mt-6 flex flex-row gap-2">
                <div className="basis-1/2">
                    <h2 className="text-lg font-semibold">Tanggal Lahir</h2>
                ...
                <div className="basis-1/2">
                    <h2 className="text-lg font-semibold">Nomor Hp/WA</h2>
                    <div>
