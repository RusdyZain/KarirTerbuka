    ...
    return (
        <div className="font-sans">
            <div className="flex flex-col items-center justify-center md:h-screen">
                ...
                <button type="submit" className="mt-4 w-6/12 text-white bg-[#2570EB] font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:duration-200 hover:bg-white hover:text-[#2570EB] hover: border-solid border-2 border-[#2570EB]">Masuk</button>
                <hr className="w-6/12 h-px my-8 bg-[#2570EB] border-0"></hr>
                <button type="button" className="w-6/12 block bg-white hover:duration-200 hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
                ...
                <button type="button" className="mt-3 w-6/12 block bg-white hover:duration-200 hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
