        ...
        <div className="font-sans">
            <div className="flex flex-col items-center justify-center h-screen sm:h-screen">
                <div className="flex flex-row place-content-center gap-4">
                    ...
                    <h1 className="place-items-center font-sans text-7xl font-medium text-[#2570EB] sm:hidden md:hidden">Daftar</h1>
                </div>
                <h1 className="mt-3 text-3xl sm:text-xl  font-bold">Mendaftarkan Akun KarirTerbuka</h1>
                <h4 className="mt-3 sm:mt-1  mb-3 sm:text-sm">Buat profil dan cari pekerjaan lebih mudah</h4>
                ...
                <div className="w-6/12 md:w-8/12 sm:w-11/12">
                    ...
                    <button type="button" className="mt-3 w-full block bg-white hover:duration-200 hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
                    ...
                    <p className="w-full text-center mt-5">Dengan melanjutkan, anda menyetujui ketentuan penggunaan disabilitas dan mengkonfirmasi bahwa Anda telah membaca Kebijakan Privasi Disabilitas.</p>
