    ...
    return (
        <div className="font-sans">
            <div className="relative bg-[url('https://watusampu.palukota.go.id/wp-content/uploads/2022/10/team6.jpg')] h-screen bg-cover bg-no-repeat">
                <div className="bg-[#210F66] absolute bottom-0 left-0 w-full h-full z-10 opacity-30"></div>
                <div className="absolute bottom-0 left-0 z-20 text-white ml-28 mb-32 md:hidden">
