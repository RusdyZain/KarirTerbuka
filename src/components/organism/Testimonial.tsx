  ...
  return (
    <section className="container pt-28 pl-[102px] px-[105px]">
      ...
      <div className="grid grid-cols-3  pt-12 px-5 gap-16">
        <div className="border-4 border-gray-400 rounded-lgo px-[30px] py-8 rounded-lg shadow-xl transition-transform transform-gpu hover:scale-105 hover:shadow-2xl">
          <Rating rating={5} />
